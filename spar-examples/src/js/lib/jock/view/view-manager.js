...
//                    }
        ...
        this.commonShowView = function (view, deferredHolder, viewSettings) {
            ...
            console.log("OH", isMainViewReplaced)
            var triggerOptions = {
        ...
        this.showViewInstance = function (viewSettings) {
            ...
            var container = function () {
                ...
                /*
                 me.complete = function (containerOptions) {
                 containerOptions = containerOptions || {};
                 containerOptions.animate = false;
                 return me.attach(null, containerOptions);
                 };*/

                me.attach = function (htmlOrRactive, containerOptions) {
                    ...
                    setTimeout(function () {
                        ...
                        var onAttached = function () {
                            ...
                            console.log("2")
                            deferredHolder.attachedDeferred.resolve({view: view, container: viewSettings.container, ractive: viewSettings.ractive});
                        ...
                        var onVisible = function () {
                            ...
                            deferredHolder.visibleDeferred.resolve({view: view, container: viewSettings.container, ractive: viewSettings.ractive});
                        ...
                        if (containerSettings.animate && !hashChange) {
                            ...
                            that.commonAttachViewWithAnim(htmlOrRactive, viewSettings);

                        } else {
                            //console.warn("show attach");
                            //settings.attachHandler(html, viewSettings);
                            that.commonAttachView(htmlOrRactive, viewSettings);
                        }
        ...
        this.showHTML = function (options) {
            ...
            setTimeout(function () {
                ...
                var onVisible = function () {
                    ...
                    deferredHolder.visibleDeferred.resolve({html: html, ractive: viewSettings.ractive});
                    //});
                };
        ...
        this.attachView = function (htmlOrRactive, viewSettings) {
            var target = viewSettings.target;
            var $target = $(target);
            var viewAttached = viewSettings.viewAttached;
            var viewVisible = viewSettings.viewVisible;

            if (typeof htmlOrRactive != 'string') {
                // It's a ractive
                var ractive = new htmlOrRactive({
                    transitionsEnabled: false, // TODO only for intro is this disabled, then it can be enabled again. Use Ractive event to enable transitions again
                    el: target,
                    onteardown: function () {
                        this._super();
                        console.log("TEARING DOWN BABY!");
                    },
                    onrender: function () {
                        this._super();
                        console.log("RENDER BABY!");
                        console.log("1");
                        viewSettings.ractive = this;
                        viewAttached(viewSettings);
                    },
                    oncomplete: function () {
                        this._super();
                        console.log("COMPLETE BABY!");
        ...
        this.commonAttachViewWithAnim = function (htmlOrRactive, viewSettings) {
            ...
            settings.animateHandler(htmlOrRactive, viewSettings);
        };

        this.attachViewWithAnim = function (htmlOrRactive, viewSettings) {
            var target = viewSettings.target;
            var $target = $(target);
            var viewAttached = viewSettings.viewAttached;
            var viewVisible = viewSettings.viewVisible;
            ...
            if (typeof htmlOrRactive != 'string') {
                ...
                var ractive = new htmlOrRactive({
                    el: target,
                    transitionsEnabled: !$.fx.off, // TODO only for intro is this disabled, then it can be enabled again. Use Ractive event to enable transitions again
                    onteardown: function () {
                        this._super();
                        console.log("TEARING DOWN BABY!");
                    },
        ...
        function onDestroyCurrentView(currentView, viewSettings) {
            ...
            if (currentView.options.overwritten) {
                // Continue processing since request was overwritten.
                return true;
            }
